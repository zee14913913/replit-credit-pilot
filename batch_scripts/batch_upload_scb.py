#!/usr/bin/env python3
"""
批量上传Standard Chartered Bank信用卡账单
客户：CHEOK JUN YOON
账单月份：2025年5-9月
"""
...
def batch_upload_scb():
    """批量上传Standard Chartered Bank账单"""
    ...
    # 账单文件列表
    files = [
        'attached_assets/SCB 14:05:2025_1760483332882.pdf',  # 5月
        'attached_assets/SCB 15:06:2025_1760483332882.pdf',  # 6月
        'attached_assets/SCB 14:07:2025_1760483332882.pdf',  # 7月
        'attached_assets/SCB 14:08:2025_1760483332882.pdf',  # 8月
        'attached_assets/SCB 14:09:2025_1760483332882.pdf',  # 9月
    ]
    
    print("=" * 80)
    print(f"开始批量上传Standard Chartered Bank账单")
        ...
        try:
            ...
            with get_db() as conn:
                ...
                if not card:
                    ...
                    ''', (
                        customer_id,
                        statement_info.get('bank', 'Standard Chartered'),

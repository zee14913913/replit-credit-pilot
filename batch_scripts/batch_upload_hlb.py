...
def batch_upload_hlb():
    """批量上传Hong Leong Bank账单"""
    ...
    # 账单文件列表
    files = [
        'attached_assets/HLB 16:06:2025_1760482619679.pdf',  # 6月
        'attached_assets/HLB 16:07:2025_1760482619682.pdf',  # 7月
        'attached_assets/HLB 16:08:2025_1760482619683.pdf',  # 8月
        'attached_assets/HLB 16:09:2025_1760482619683.pdf',  # 9月
    ]
    
    print("=" * 80)
    print(f"开始批量上传Hong Leong Bank账单")
        ...
        try:
            ...
            with get_db() as conn:
                ...
                if not card:
                    ...
                    ''', (
                        customer_id,
                        statement_info.get('bank', 'Hong Leong Bank'),

...
### 3.1 客户仪表板
**这是做什么的：**
一个页面看到客户的所有信息：所有信用卡、账单、消费分类、分期付款。
...
### 9.2 预算管理
**这是做什么的：**
为每个消费类别设置月度预算，超支时发出警告。

**怎么使用：**
1. 进入"预算管理"
2. 为每个类别设置预算（如餐饮RM 1,000）
3. 系统自动追踪
...
1. **银行新闻系统** → 可以移除或外包给第三方新闻源
2. **预算管理** → 可以简化为简单的月度限额提醒
3. **复杂的分期追踪** → 大部分信息已经在账单里了
4. **过多的报告类型** → 统一为一种标准报告
5. **重复的分析图表** → 保留最常用的几个

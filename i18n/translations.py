...
TRANSLATIONS = {
    'en': {
        ...
        'month_of_statement': 'Month of Statement',
        'client_code': 'Client\'s Code',
        'bank': 'Bank',
        'due_date': 'Due Date',
        'due_total': 'Due Total',
        'owner_expenses': 'Owner\'s Expenses',
        'owner_payments': 'Owner\'s Payment',
        'infinite_expenses': 'INFINITE\'s Expenses',
        'infinite_payments': 'INFINITE\'s Payment',
        'owner_os_bal': 'Owner\'s OS Bal',
        'infinite_os_bal': 'INFINITE\'s OS Bal',
    ...
    'zh': {
        ...
        'month_of_statement': '账单月份',
        'client_code': '客户代码',
        'bank': '银行',
        'due_date': '到期日',
        'due_total': '应付总额',
        'owner_expenses': 'Owner消费',
        'owner_payments': 'Owner还款',
        'infinite_expenses': 'INFINITE消费',
        'infinite_payments': 'INFINITE还款',
        'owner_os_bal': 'Owner欠款余额',
        'infinite_os_bal': 'INFINITE欠款余额',
        'monthly_credit': '月度进账',
        'monthly_debit': '月度出账',
        'closing_bal': '结余',

...
**❌ 禁止将客户原件存放在其他位置：**
- ❌ `attached_assets/` - 这是临时上传区
- ❌ `archive_old/` - 这是测试文件归档区
- ❌ 项目根目录或任何其他位置

**📝 文件命名规范：**
- 信用卡账单：`{BankName}_{CardLast4}_{YYYY-MM-DD}.pdf`
- 示例：`AmBank_6354_2025-05-28.pdf`、`HSBC_0034_2025-09-13.pdf`
...
**📖 详细规范：**请查看 `STORAGE_GUIDELINES.md`
